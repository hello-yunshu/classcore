...
| 依赖 | 版本 | 用途 | 许可证 | 备注 |
|---|---:|---|---|---|
| `@web-ppt/core` | `0.5.0-beta.2` | 文档模型与 OOXML 解析 | MIT | 运行时依赖 |
| `@web-ppt/edit-core` | `0.5.0-beta.2` | 编辑命令与撤销重做 | MIT | 运行时依赖 |
| `@web-ppt/editor` | `0.5.0-beta.2` | 网页编辑器挂载 | MIT | 运行时依赖 |
| `@web-ppt/viewer-core` | `0.5.0-beta.2` | 播放与动画控制 | MIT | 运行时依赖 |
